		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Five Crowns",
									"targetURL": "#nzcomurrayfivecrowns-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nzcomurrayfivecrowns-display": {
								"semanticObject": "nzcomurrayfivecrowns",
								"action": "display",
								"description": "Five Crowns scorring app",
								"title": "Five Crowns",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nz.co.murray.fivecrowns",
									"url": sap.ui.require.toUrl("nz/co/murray/fivecrowns")
								}
							}
						}
					}
